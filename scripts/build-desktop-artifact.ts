...
const DESKTOP_APP_ID = "click.lagaryan.doer";
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    artifactName: "Doer-${version}-${arch}.${ext}",
    ...
    buildConfig.mac = {
      ...
      extendInfo: {
        NSScreenCaptureUsageDescription:
          "Doer captures the active window when you use the window capture shortcut.",
      },
      protocols: [
        {
          name: "Doer",
          schemes: ["doer", "doer-dev"],
        },
      ],
  ...
  if (platform === "linux") {
    buildConfig.linux = {
      ...
      // doer:// OAuth callbacks to the app.
      protocols: [
        {
          name: "Doer",
          schemes: ["doer", "doer-dev"],
