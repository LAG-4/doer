    ...
    <Dialog open disablePointerDismissal onOpenChange={(_, event) => event.cancel()}>
      ...
      >
        <WizardHeader
          title="Set up Doer"
          identity={
            <div className="flex items-baseline gap-1.5" role="img" aria-label="Doer">
              <T3Wordmark className="h-5 w-auto shrink-0" />
            </div>
          }
        >
          <WizardSteps
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start Doer first, or run <code className="font-mono">npx t3 serve</code>. Add{" "}
