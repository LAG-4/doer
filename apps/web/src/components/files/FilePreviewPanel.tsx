...
export default function FilePreviewPanel({
  ...
  // costs an open and a stat and returns no body. Sheets skip the read (grid owns data).
  ...
  useWorkspaceMutationRefresh({
    enabled:
      ...
      // it notices when the path becomes a file. Sheets never re-read (grid owns data).
        ...
        {showExplorer ? (
          ...
          >
            <FileBrowserPanel
              ...
              onOpenFile={onOpenFile}
              workspaceMutationId={workspaceMutationId}
              {...(previewPath && !isMedia && !isPdf && !isSheetEditable
