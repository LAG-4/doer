...
/**
 * The palette Doer wears with no theme installed, captured from the app's
...
/**
 * The standard Doer look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Doer shows without a theme, read from the app's own
