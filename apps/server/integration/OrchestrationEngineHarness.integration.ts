...
import * as AutomationSchedulerReactor from "../src/orchestration/AutomationSchedulerReactor.ts";
...
export const makeOrchestrationIntegrationHarness = (
  ...
  Effect.gen(function* () {
    ...
    const orchestrationReactorLayer = OrchestrationReactorLive.pipe(
      ...
      Layer.provideMerge(
        Layer.succeed(AutomationSchedulerReactor.AutomationSchedulerReactor, {
          start: () => Effect.void,
          drain: Effect.void,
        }),
      ),
