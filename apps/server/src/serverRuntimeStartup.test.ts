    ...
    const targets = yield* ServerRuntimeStartup.resolveAutoBootstrapWelcomeTargets.pipe(
      Effect.provide(
        ServerSettings.layerTest({
          ...
          // Codex is off by default on this fork; opt in so the project
          // override below exercises precedence instead of the
          // disabled-provider fallback in resolveProjectSettings.
