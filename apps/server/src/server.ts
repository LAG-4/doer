...
import { telemetryConfigRouteLayer } from "./telemetry/TelemetryConfigRoute.ts";
...
import * as AutomationSchedulerReactor from "./orchestration/AutomationSchedulerReactor.ts";
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(AutomationSchedulerReactor.layer),
...
const ComputerLayerLive = ComputerService.layer.pipe(Layer.provide(ProcessRunner.layer));
